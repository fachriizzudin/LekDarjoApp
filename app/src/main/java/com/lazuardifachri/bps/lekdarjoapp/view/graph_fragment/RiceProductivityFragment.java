...
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphRiceProductivityBinding;
...
public class RiceProductivityFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphRiceProductivityBinding binding;
    ...
    public RiceProductivityFragment() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphRiceProductivityBinding.inflate(inflater, container, false);
