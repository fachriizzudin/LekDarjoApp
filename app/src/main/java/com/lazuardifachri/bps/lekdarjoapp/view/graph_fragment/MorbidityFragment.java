...
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphMorbidityBinding;
...
public class MorbidityFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphMorbidityBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphMorbidityBinding.inflate(inflater, container, false);
