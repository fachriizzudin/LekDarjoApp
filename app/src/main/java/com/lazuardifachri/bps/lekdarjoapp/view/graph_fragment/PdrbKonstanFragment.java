...
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphPdrbKonstanBinding;
...
public class PdrbKonstanFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphPdrbKonstanBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphPdrbKonstanBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        barChart = GraphUtil.setChart(barChart);
        ...
        viewModel.pdrbKonstanDataLive.observe(getViewLifecycleOwner(), graphData -> {
            ...
            if (graphData != null) {
                ...
                barChart = GraphUtil.setChartData(barChart, graphData, minYear, 2);
    ...
    public void onSeeking(SeekParams seekParams) {
        barChart = GraphUtil.setChartData(barChart, this.graphData, xSeekBar.getProgress(), ySeekBar.getProgressFloat());
    }
