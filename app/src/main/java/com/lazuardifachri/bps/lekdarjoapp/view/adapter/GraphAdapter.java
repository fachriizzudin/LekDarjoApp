...
import com.lazuardifachri.bps.lekdarjoapp.view.listener.GraphMetaCLickListener;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

public class GraphAdapter extends RecyclerView.Adapter<GraphAdapter.GraphMetaViewHolder> implements GraphMetaCLickListener {

    private final ArrayList<Graph> graphList;
    private Context context;

    public GraphAdapter(ArrayList<Graph> graphList, Context context) {
        this.graphList = graphList;
        this.context = context;
    }

    public void updatePublication(List<Graph> newGraphList) {
    ...
    public void onBindViewHolder(@NonNull GraphMetaViewHolder holder, int position) {
        ...
        if (isIncrease(graph.getData())) {
            holder.itemView.upArrow.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_up));
        } else {
            holder.itemView.upArrow.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_down));
        }
    }

    @Override
    public void onGraphMetaClick(View v) {
