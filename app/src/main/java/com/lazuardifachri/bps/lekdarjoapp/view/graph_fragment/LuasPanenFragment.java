...
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphLuasPanenBinding;
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphRiceProductionBinding;
...
public class LuasPanenFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphLuasPanenBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphLuasPanenBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.luasPanenDataLive.observe(getViewLifecycleOwner(), graphData -> {
            ...
            if (graphData != null) {
                ...
                lineChart = GraphUtil.setChartData(lineChart, graphData, minYear, 2, 2);
    ...
    public void onSeeking(SeekParams seekParams) {
        lineChart = GraphUtil.setChartData(lineChart, this.graphData, xSeekBar.getProgress(), ySeekBar.getProgressFloat(), 2);
    }
