...
public class StatisticalNewsViewModel extends AndroidViewModel {
    ...
    public StatisticalNewsViewModel(@NonNull Application application) {
        super(application);
    }
                ...
                statisticalNewsApi.getStatisticalNews()
                        ...
                        .subscribeWith(new DisposableSingleObserver<StatisticalNewsResponse>() {
                            ...
                            public void onSuccess(@NonNull StatisticalNewsResponse response) {
                                ...
                                insertAllToDatabase(response.getStatisticalNews());
                                Log.d("statistical_news", response.getStatisticalNews().toString());
    ...
    public void fetchBySubjectFromDatabase(int subjectId, int month, int year) {
        loading.setValue(true);
    ...
    public void fetchByCategoryFromDatabase(int categoryId, int month, int year) {
        loading.setValue(true);
        String monthYear = "%" + month + "-" + year;
        disposable.add(myDatabase.getInstance(getApplication())
    ...
    public void fetchByMonthYearFromDatabase(int month, int year) {
        loading.setValue(true);
        String monthYear = "%" + month + "-" + year;
        disposable.add(myDatabase.getInstance(getApplication())
