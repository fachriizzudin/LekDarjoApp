...
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphPdrbBinding;
...
public class PDRBFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphPdrbBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphPdrbBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        lineChart = GraphUtil.setChart(lineChart, 3);
