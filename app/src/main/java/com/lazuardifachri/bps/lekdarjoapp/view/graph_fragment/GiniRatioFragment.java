...
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphGiniRatioBinding;
...
public class GiniRatioFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphGiniRatioBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphGiniRatioBinding.inflate(inflater, container, false);
