...
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphIpmBinding;
...
public class IpmFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphIpmBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphIpmBinding.inflate(inflater, container, false);
