...
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphInflationBinding;
...
public class InflationFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphInflationBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphInflationBinding.inflate(inflater, container, false);
