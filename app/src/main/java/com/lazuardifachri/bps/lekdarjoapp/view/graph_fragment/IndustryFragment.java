...
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphIndustryBinding;
...
public class IndustryFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphIndustryBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphIndustryBinding.inflate(inflater, container, false);
