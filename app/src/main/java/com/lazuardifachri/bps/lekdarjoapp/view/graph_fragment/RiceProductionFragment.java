...
import com.lazuardifachri.bps.lekdarjoapp.databinding.FragmentGraphUnemploymentBinding;
...
public class RiceProductionFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphRiceProductionBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphRiceProductionBinding.inflate(inflater, container, false);
