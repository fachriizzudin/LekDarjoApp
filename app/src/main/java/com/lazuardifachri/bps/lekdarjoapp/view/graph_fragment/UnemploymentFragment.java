...
public class UnemploymentFragment extends Fragment implements OnSeekChangeListener {

    private FragmentGraphUnemploymentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = FragmentGraphUnemploymentBinding.inflate(inflater, container, false);
